...
object FakeSkincareDataSource {
    val dummySkincare = listOf(
        ...
        Skincare(
            ...
            "SKINTIFIC 360 Crystal Massager Lifting Eye Cream 20g -Brightning【BPOM】 - eye cream",
            "Eye cream supercharged yang mengandung 3D Peptide Complex dan Niacinamide untuk mengurangi garis-garis halus, kerutan, sembab, serta mencerahkan area bawah mata yang gelap. Dilengkapi dengan teknologi 360 ° Crystal Rolling Massager, sebuah teknologi Lift-Tech ™ dari Jerman dengan 184 permukaan kristal dan dapat berputar searah 360 °, sehingga membantu daya serap kandungan aktif pada kulit dan mengurangi garis-garis halus yang terlihat & kantung mata di waktu yang bersamaan.\nLift-Tech™ 360 ° Crystal Roll Massager yang terdapat pada eye cream ini membantu mengurangi garis-garis halus, mengurangi area bawah mata yang gelap, dan mengurangi tampilan mata sembab.",
            167000
        ),
        Skincare(
            6,
        ...
        Skincare(
            ...
            "Diformulasikan dengan Mugwort, ingredients yang populer di Korea untuk mengobati jerawat. Dilengkapi dengan Niacinamide, Salicylic Acid, dan juga Centella yang dapat mengontrol produksi minyak, membersihkan pori-pori secara mendalam, membersihkan komedo, dan menenangkan kulit yang sedang meradang. Mudah digunakan dengan bentuk stick, berfokus untuk menenangkan kulit dan meredakan kemerahan, membersihkan pori dan merawat kulit berjerawat, mengontrol minyak dan menjaga skin barrier. Coverage yang baik, dengan 1 usapan dapat menutup satu area pada wajah. Hasil penggunaan bruntusan berkurang, pori-pori mengecil, warna kulit lebih cerah dan merata.",
            79000
        ),
        Skincare(
            8,
            R.drawable.product_8,
            "NPURE Marigold Sheet Mask Youth Defense",
            "Masker wajah yang setiap lembarannya mengandung Ekstrak Marigold, 8X Essential Vitamins, dan 5X Peptides yang nyaman dan lembut di kulit untuk membantu merawat kulit, mencegah penuaan dini, menyamarkan garis halus, dan meratakan warna kulit. Kulit akan terasa lebih lembap, kenyal, dan tampak muda bercahaya.",
            16900
        ),
        Skincare(
            9,
            R.drawable.product_9,
            "Garnier Micellar Water Blue Salicylic BHA - Salicylic 400ml",
            "BARU! Garnier Micellar Salicylic BHA! Angkat tuntas makeup dan kotoran, serta kurangi 99% bakteri penyebab jerawat. Wajah bersih, gak takut jerawat!\nUntuk pertama kalinya, Garnier menggabungkan Teknologi Micelles dengan Salicylic BHA untuk melawan jerawat serta Vitamin C yang mencerahkan. Micelles mengangkat kotoran, debu, dan makeup seperti magnet, sementara Salicylic BHA mengangkat sel kulit mati serta melawan jerawat, serta Vitamin C mencerahkan kusam dan menyamarkan noda hitam. Cocok untuk kulit kusam, berminyak, dan rentan berjerawat. Tanpa parfum, hypoallergenic.",
            91840
        ),
        Skincare(
            10,
            R.drawable.product_10,
            "SOMETHINC SKIN GOALS Vita Propolis Glow Essence Toner - 40ml",
